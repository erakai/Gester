...
class Color(Attribute):
	...
	def __init__(self, _id : str, red = DEFAULT_R, blue = DEFAULT_B, 
		green = DEFAULT_G, alpha = DEFAULT_A):
		super().__init__(_id)
		self._set("red", red)
		self._set("blue", blue)
	...
	def get(self):
		return (self._get("red"), self._get("blue"), 
			self._get("green"), self._get("alpha"))
