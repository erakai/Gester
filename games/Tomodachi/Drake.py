...
import config
from spawner import BoxSpawner, BoxSpawner2
...
class Drake(Rect):
    ...
    def start(self):
        ...
        sounds.create_sound("Drake1", "games/assets/sounds/drake_vl1.mp3")
        self.position.set(self.x, self.y)
        self.size.set(100, 100)
        self.platform_image = pygame.image.load("games/assets/drake_avatar.jpg")
